...
class tcp_0018_initial_sync:
    data_dict = [
        ...
        {'name': 'unk2', 'n_bytes': 4, 'cast': bytes_to_hex}, # C0000264
        {'name': 'unk3', 'n_bytes': 4, 'cast': bytes_to_hex}, # 65180000
        {'name': 'unk4', 'n_bytes': 4, 'cast': bytes_to_hex}, # 00000000
        {'name': 'unk5', 'n_bytes': 4, 'cast': bytes_to_hex}, # 98500000
        {'name': 'unk6', 'n_bytes': 4, 'cast': bytes_to_hex}, # 01000000
    ]
    ...
    def build(self):
        packet = [
            {'name': __name__},
            {'dme_id': b'\x00\x18'},
            {'data': hex_to_bytes('0200000001000000C0000264B118000049144291B41B000001000000')}
        ]
        return packet
