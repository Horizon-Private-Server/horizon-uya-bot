...
class tcp_0004_tnw:
    ...
    def to_bytes(self):
        if self.tnw_type == 'tNW_PlayerData':
            # return self.id + \
            #     hex_to_bytes("000000000200000001001D006697480000000000") + \
            #     str_to_bytes("tNW_PlayerData", 15) + \
            #     # hex_to_bytes("")
