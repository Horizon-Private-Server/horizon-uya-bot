...
class static_shoot_initial(State):
    ...
    def update(self):
        ...
        unk1 = "0000"
        unk2 = "D543"
        unk2 = bytes_to_hex(int_to_bytes_little(2, target_local[0]))
        unk3 = "0000"
        unk4 = "5344"
        unk4 = bytes_to_hex(int_to_bytes_little(2, target_local[1]))
        unk5 = "0000"
        unk6 = "E942"
        unk6 = bytes_to_hex(int_to_bytes_little(2, target_local[2]))
