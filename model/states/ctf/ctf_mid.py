...
class ctf_mid(ctf_main):
    def __init__(self, state_machine):
        super().__init__(state_machine)
        self.reached_start = False
        self.mid_coord = [0,0,0]
    ...
    def enter(self, msg:dict):
        ...
        self.mid_coord = self.state_machine.game_state.map.get_area_coord('mid', team)
    ...
    def update(self):
        ...
        if self.reached_start == False:
            ...
            new_coord = self.state_machine.game_state.map.path(self.state_machine.game_state.player.coord, self.mid_coord, chargeboot=True)
